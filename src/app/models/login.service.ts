...
import { User } from './exercises';
import { Http } from '@angular/http';
import { Router } from '@angular/router';
import { ExerciseEquip } from './exercises';
...
export class LoginService {
    ...
    login(name: string, password: string, fbid?: string, picture?: string){
        this.http.post(this.apiRoot + "/login/room/players", { name, password, fbid, picture }).subscribe(
            data => {
                this.me = data.json();
                console.log(data);
            },
